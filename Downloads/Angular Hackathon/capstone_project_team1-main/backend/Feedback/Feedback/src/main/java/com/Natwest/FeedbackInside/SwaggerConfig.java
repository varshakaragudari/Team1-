package com.Natwest.FeedbackInside;
...
public class SwaggerConfig {
    ...
    public Docket apiDocket() {
        Docket docket =  new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.Natwest.FeedbackInside"))
    ...
    private ApiInfo apiInfo(){
        return new ApiInfoBuilder()
                ...
                .description("Sample feedbacks Generateed Using SWAGGER2 for our Book Rest API")
