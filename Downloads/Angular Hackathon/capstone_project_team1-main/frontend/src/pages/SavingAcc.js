...
</div>
{
   allGoals.map(temp=>{
    ...
    <div class="progress">
  <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style={{width: temp.goalPercent+"%"}}>{temp.goalPercent}%</div>
</div>
</>
   )
   })
...
<a title='Add a goal' href='#' class="Switch-link p-4 mr-2 " data-bs-toggle="modal" data-bs-target="#exampleModal">
