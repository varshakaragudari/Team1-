...
let AddGoal=()=>{
  ...
  return (
    <>
    <div className='Dashboard-body d-flex flex-row '  >
    <Sidebar/>
...
<div class=" Accounts d-flex flex-row col-md-16 ">
   
    <div className=' col CurrentAcc shadow-sm bg-body rounded'>
    ...
    <div class="col SavingAcc shadow-sm bg-body rounded" >
        <div class="Account-info">
    ...
    <div class="Saving-summary" style={{width:"fit-content"}}>
<div class="container mx-auto">
  <div class="row">
    <div class="Saving-Body col-md-8 p-3 shadow bg-body rounded" style={{marginTop:"6%"}}>
<div>
      <div class="Content row" >
        ...
        <div class=" Saving-Button d-flex flex-row ">
          <Link to="/withdraw">
          <a title='Withdraw Amount' href='#' class="Switch-link">
       <span class="Switch-Btn p-2">Withdraw Amount</span>
       </a>
          </Link>
        
      <Link to="/dashboard"> <a title='Increase Round up' href='#' class="Switch-link ">
       <span class="Switch-Btn p-2">Increase Round up</span>
       </a></Link>
     <Link to="/addAmount">
     <a title='Add amount' href='#' class="Switch-link ">
...
<div class=" col fancyImg d-flex flex-column p-2  ">
  <h2 class="fw-bold">Save while you spend!</h2>
    ...
    <a title='Increase round up' href='#' class="promotion-link">
       ...
       <img src={Payment} style={{height:'20rem',width:'20rem'}}></img>
